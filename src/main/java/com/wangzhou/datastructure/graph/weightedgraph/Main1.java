...
public class Main1 {
    public static void main(String[] args) {
        String filename1 = "src\\main\\java\\com\\wangzhou\\datastructure\\graph\\weightedgraph\\testG1.txt";
        int V1 = 8;

        String filename2 = "src\\main\\java\\com\\wangzhou\\datastructure\\graph\\weightedgraph\\testG2.txt";
        int V2 = 250;

        String filename3 = "src\\main\\java\\com\\wangzhou\\datastructure\\graph\\weightedgraph\\testG3.txt";
        int V3 = 1000;

        String filename4 = "src\\main\\java\\com\\wangzhou\\datastructure\\graph\\weightedgraph\\testG4.txt";
        int V4 = 10000;
...
//        System.out.println( filename5 + " load successfully.");
        ...
        LazyPrimMST<Double> lazyPrimMST1 = new LazyPrimMST<Double>(g1,0);
        endTime = System.currentTimeMillis();
        System.out.println("Test for G1: " + (endTime - startTime) + "ms.");

        startTime = System.currentTimeMillis();
        LazyPrimMST<Double> lazyPrimMST2 = new LazyPrimMST<Double>(g2,0);
        endTime = System.currentTimeMillis();
        System.out.println("Test for G2: " + (endTime - startTime) + "ms.");

        startTime = System.currentTimeMillis();
        LazyPrimMST<Double> lazyPrimMST3 = new LazyPrimMST<Double>(g3,0);
        endTime = System.currentTimeMillis();
        System.out.println("Test for G3: " + (endTime - startTime) + "ms.");

        startTime = System.currentTimeMillis();
        LazyPrimMST<Double> lazyPrimMST4 = new LazyPrimMST<Double>(g4,0);
        endTime = System.currentTimeMillis();
...
//        System.out.println("Test for G5: " + (endTime-startTime) + "ms.");
        ...
        startTime = System.currentTimeMillis();
        PrimMST<Double> primMST1 = new PrimMST<Double>(g1,0);
        endTime = System.currentTimeMillis();
        System.out.println("Test for G1: " + (endTime - startTime) + "ms.");

        startTime = System.currentTimeMillis();
        PrimMST<Double> primMST2 = new PrimMST<Double>(g2,0);
        endTime = System.currentTimeMillis();
        System.out.println("Test for G2: " + (endTime - startTime) + "ms.");

        startTime = System.currentTimeMillis();
        PrimMST<Double> primMST3 = new PrimMST<Double>(g3,0);
        endTime = System.currentTimeMillis();
        System.out.println("Test for G3: " + (endTime - startTime) + "ms.");

        startTime = System.currentTimeMillis();
        PrimMST<Double> primMST4 = new PrimMST<Double>(g4,0);
        endTime = System.currentTimeMillis();
        System.out.println("Test for G4: " + (endTime - startTime) + "ms.");
