 ...
 * Time:10:14
 **/
public class NextMoreBigElement {
            ...
            for (int j = 0; j < nums2.length; j++) {
                if (nums1[i]==nums2[j]) {
                    if (j == nums2.length - 1) {
                        ...
                        int a=j+1;
                        if(isExist(a,i,j,nums1,nums2,output)){
    ...
    public static void main(String[] args) {
        ...
        NextMoreBigElement nextMoreBigElement = new NextMoreBigElement();
        int[] ints = nextMoreBigElement.nextGreaterElement(new int[]{1,3,5,2,4}, new int[]{6,5,4,3,2,1,7});
        for (int i : ints) {
